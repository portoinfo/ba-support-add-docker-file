  ...
  <div>
    ...
    >
      ...
      <b-navbar-brand href="/home">
        ...
        <div v-if="cslogo == ''">
          <!-- <img src="images/meta/logo.png" alt="Builderall Booking" class="mx-4 mb-1 d-none d-sm-inline-block"> -->
            <img src="/images/layout6/helpdesk-new.svg" alt="Builderall HelpDesk" height="33px">
            ...
            <div class="mx-3 mx-sm-4 d-flex align-items-center">
                ...
                <b-navbar-nav style="display: contents;">
                    <div class="flex-fill d-flex flex-column m-3">
                        <span class="status-select-container" v-if="csname != ''">
                            <div v-if="status_selected == 'online'" class="status-circle green"></div>
                            <div v-if="status_selected == 'busy'" class="status-circle red"></div>
                            <div v-if="status_selected == 'appear_away'" class="status-circle yellow"></div>
                            <v-select
                    ...
                    >
                        ...
                        <template v-else v-slot:button-content>
                            ...
                            >
                                ...
                                />
                                <!-- <svg id="Componente_26_1" data-name="Componente 26 – 1" xmlns="http://www.w3.org/2000/svg" width="31.001" height="34.287" viewBox="0 0 31.001 34.287">
                                    <path id="Subtração_14" data-name="Subtração 14" d="M8.822,25.114H0V7.846L11.766,0l11.21,7.468v5.186a11.626,11.626,0,0,0-2.65-.3c-.21,0-.423.006-.633.017v-3.4L11.766,3.924l-8.485,5.4V21.831H8.2V11.983H14.77V13.77A11.575,11.575,0,0,0,8.761,23.917a11.748,11.748,0,0,0,.061,1.2Z" transform="translate(0.003 -0.001)" fill="#6cadfe"/>
                                    <path id="Caminho_358" data-name="Caminho 358" d="M10.46,7.139H5.831L7.853,5.117a.418.418,0,0,0,0-.588.413.413,0,0,0-.584,0L4.539,7.259a.413.413,0,0,0,0,.584l2.731,2.731a.413.413,0,0,0,.584-.584L5.831,7.968H10.46a.414.414,0,0,0,0-.829Z" transform="translate(13.325 17.116)" fill="#0F7BFF" stroke="#0F7BFF" stroke-width="1"/>
                                    <g id="Elipse_166" data-name="Elipse 166" transform="translate(13.001 16.287)" fill="none" stroke="#0F7BFF" stroke-width="2">
                        ...
                        >
                            <img
                                :src="
                                    `${base_url}/images/icons/calendar.svg`
                                "
                                class="pl-3 pr-3"
                            />
                            {{ $t("Agenda") }}
            ...
            <div class="modal-dialog modal-dialog-centered modal-md">
                <div class="modal-content pr-3 pl-3">
                    ...
                    <div class="modal-footer border-0" style="justify-content: space-between;">
                        <a v-if="is_hs == 'false'" class="btn btn-danger text-capitalize" :href="`${base_url}/logout`">{{ $t("bs-exit") }}</a>
                        <button
                            v-if="is_hs != 'false'"
                            type="button"
        ...
        <!-- modal agenda   -->
        <div class="modal" tabindex="-1" id="modalSchedule" data-backdrop="static">
            <div class="modal-dialog modal-dialog-centered modal-lg" style="max-width: 840px !important;">
                <div class="modal-content pr-3 pl-3">
                    <div class="modal-header border-0">
                        <b-row>
                            <b-col class="ml-1" cols="12">
                                    <h5 class="modal-title"><b>{{ $t("bs-schedule") }}</b></h5>
                            </b-col>
                        </b-row>
                        <button
                            type="button"
...
export default {
    ...
    methods: {
        ...
        onSubmitSchedule(){
            axios.post("/department/post-schedule", {
				hoursPerDay: this.hoursPerDay,
                workingStatus: this.workingStatus,
                timezone: this.timezoneSelected,
                company_user_id: this.session_user_company.company_user_id,
			}).then(function(response){
				if(response.data.success){
                    $("#modalSchedule").modal("hide");
				}else{
					this.$snotify.error(this.$t('bs-error-updating-department'), this.$t('bs-error'));
				}
			})
			.catch(function(){
				console.log('FAILURE!!');
...
.workcss{
    ...
    padding-top: 8px;
    border-radius: 10px;
    box-shadow: 0px 2px 8px 0px #cdcdcd;
}
