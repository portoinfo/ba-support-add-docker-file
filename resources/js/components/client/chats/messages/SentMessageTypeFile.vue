<template>
    <v-row no-gutters justify="end">
        <v-col cols="11" xl="6" lg="7" md="9" sm="9" class="text-left">
            <v-row no-gutters>
                <v-col style="width: 1px" class="mt-1">
                    <div class="bubble-right" style="max-width: 270px;">
                            ...
                            <v-list-item class="px-1">
                                <v-list-item-content>
                                    ...
                                    <v-list-item-subtitle>
                                        <v-btn class="text-left text-capitalize px-0" height="60" color="input" target="_blank" :href="`${$store.state.baseURL}/chat/files/${chat.hash_id}/${unique_name}`">
