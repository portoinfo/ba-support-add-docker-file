...
<div class="w-100 h-100 p-0 m-0 non-selectable" v-if="!loading">
    <div class="table-responsive" :class="{'paginated': !non_paginated}">
        <table class="table table-sm table-bordered table-striped">
            ...
            <tbody>
                 <template v-for="(q, i3) in chats.data">
                    <tr
                        :key="i3"
                    ...
                    >
                        ...
                        <td class="text-left td-name" @click="callSetInfo(q)" v-b-toggle.sidebar-right-info-2>
                            <gravatar
                                ...
                                :status="$status.get(q.id_created)"
                                :size="gravatarSize"
                        ...
                        <td class="text-left td-name" v-if="q.name" @click="callSetInfo(q)" v-b-toggle.sidebar-right-info-2>
                          <gravatar
                              :email="q.email"
                              :status="$status.get(q.operator_id)"
                              :size="gravatarSize"
                              :name="$t(q.name)"
                              color="primary"
                              class="mr-2 ml-1"
                        ...
                        <td v-else @click="callSetInfo(q)" v-b-toggle.sidebar-right-info-2> -- </td>
                        ...
                        <td @click="callSetInfo(q)" v-b-toggle.sidebar-right-info-2>
        ...
        <div class="row">
            ...
            <div class="col pl-0">
                <pagination
                    ...
                    :data="chats"
                    :show-disabled="true"
                    @pagination-change-page="getChatsCanceled"
                >
...
export default {
  ...
  created() {
    this.$root.$refs.TableCanceled = this;
    this.callResetTable();
  ...
  methods: {
    orderTickets(order){
        ...
        this.$emit('orderTickets', 'CANCELED');
    },
    aplicColor(order){
        if(order == null){
