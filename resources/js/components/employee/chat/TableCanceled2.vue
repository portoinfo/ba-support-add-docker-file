            ...
            <tbody>
                 <template v-for="(q, i3) in chats.data">
                    ...
                    >
                        ...
                        <td class="text-left td-name" v-if="q.operator || q.is_robot">
                          <gravatar
                              :email="q.is_robot ? 'grey' : q.operator_email"
                              :status="q.is_robot ? 'false' : $status.get(q.operator_id)"
                              :size="gravatarSize"
                              :name="q.is_robot ? $t('bs-robot') : $t(q.operator)"
                              class="mr-2 ml-1"
                          />
                          {{ q.is_robot ? $t('bs-robot') :q.operator }}
                        </td>
                        <td v-else> -- </td>
                        <td class="text-left">
