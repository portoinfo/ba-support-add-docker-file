...
class ProDashboardCompanyChatsAverageTimeQueueAndService extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $sql = "
        CREATE DEFINER=CURRENT_USER PROCEDURE `pro_dashboard_company_chats_average_time_queue_and_service`(IN pIdCompany INT, IN pFilterPeriod ENUM('LAST_24_HOURS', 'LAST_7_DAYS', 'LAST_30_DAYS', 'LAST_365_DAYS'))
        BEGIN
            SET @SQL_Final = 
                CONCAT('SELECT
