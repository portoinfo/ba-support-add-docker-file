...
class ProDashboardAttendantTicketsChatsOpenedXClosed extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        DB::unprepared("DROP procedure IF EXISTS `pro_dashboard_attendant_tickets_chats_opened_x_closed`;");
    }
}
