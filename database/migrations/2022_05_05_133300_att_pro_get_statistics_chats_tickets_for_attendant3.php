...
class AttProGetStatisticsChatsTicketsForAttendant3 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::unprepared("
            ...
            SET @SQL_Final = 
                IF(pType = 'CHAT',
                    CONCAT('SELECT
                            user_auth.id, user_auth.name as attendant, (company_user.deleted_at IS NOT NULL) AS user_removed, company_user.last_login, company_user.id as company_user_id, 
