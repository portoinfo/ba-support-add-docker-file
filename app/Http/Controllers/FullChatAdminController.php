...
class FullChatAdminController extends Controller
{
    public function getChatsOnQueue(Request $request)
    {
        ...
        try {
            ...
            Logger::reportException($e, [], ['full-chat-admin-controller', 'getChatsOnQueue'], false);
        }
    }
    ...
    public function getChatsInProgress(Request $request)
    {
        ...
        try {
            ...
            Logger::reportException($e, [], ['full-chat-admin-controller', 'getChatsInProgress'], false);
        }
    }
    public function getChatsClosed(Request $request)
    {
        ...
        try {
            ...
            Logger::reportException($e, [], ['full-chat-admin-controller', 'getChatsClosed'], false);
        }
    }
    ...
    public function getChatsResolved(Request $request)
    {
        ...
        try {
            ...
            Logger::reportException($e, [], ['full-chat-admin-controller', 'getChatsResolved'], false);
        }
    }
    ...
    public function getChatsFinished(Request $request)
    {
        ...
        try {
            ...
            // echo $e;
            Logger::reportException($e, [], ['full-chat-admin-controller', 'getChatsFinished'], false);
        }
    }
    ...
    public function setEmployee(Request $request)
    {
        ...
        try {
            ...
            $cucdController = new CompanyUserCompanyDepartmentController();
            $cucdController->addAgentToDepartment($request);

            //return response()->json($cucdController);
            /** send exception to logger */
        } catch (\Exception $e) {
            Logger::reportException($e, [], ['full-chat-admin-controller', 'setEmployee'], false);
        }
    }
}
